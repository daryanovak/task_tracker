...
class TaskCommandParsers:
    ...
    def create_task_parser(self):#проверить парэент ид чтобы коррек
    ...
    def edit_task_title_parser(self):
        ...
        parser_append.add_argument('task_id', help='Title of tasks', default='Title')
    ...
    def edit_task_text_parser(self):
        ...
        parser_append.add_argument('task_id', help='Title of tasks.py', default='Title')
    ...
    def get_subtasks_parser(self): #++++++
        ...
        parser_append.add_argument('task_id', help='', default='Title of tasks')
    ...
    def get_tasks_on_period_parser(self):#----------посчитать для периодичной задачи даты периода
