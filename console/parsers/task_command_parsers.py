...
class TaskCommandParsers:
    ...
    def init_authorized_commands(self):
        ...
        self.delete_task_by_title_parser()
    ...
    def create_task_parser(self):
        parser_append = self.subparsers.add_parser('create_task', help='Create new task.py')
        parser_append.add_argument('title', help='Title of task.py', default='Title')
        parser_append.add_argument('text', help='Text of task.py', default='Empty text')
        ...
        parser_append.add_argument('--parent_title', help='Parent title', default='')
    ...
    def create_periodic_task_parser(self):
        parser_append = self.subparsers.add_parser('create_periodic_task', help='Create new task.py')
        parser_append.add_argument('title', help='Title of task.py', default='Title')
        parser_append.add_argument('text', help='Text of task.py', default='Empty text')
        parser_append.add_argument('status', help='Complete status', default='0', choices=['0', '1', '2'])
        ...
        parser_append.add_argument('--tags', help='Tags', default='')
        parser_append.add_argument('--parent_title', help='Parent title', default=None)

        parser_append.set_defaults(func=self.view.create_new_periodic_task)

    def get_task_by_title_parser(self):
        parser_append = self.subparsers.add_parser('task_by_title', help='Get task.py by title')
        parser_append.add_argument('title', help='Title of task.py', default='')
        parser_append.set_defaults(func=self.view.get_task_by_title)

    def delete_task_by_title_parser(self):
        parser_append = self.subparsers.add_parser('delete_task', help='Delete task.py by title')
        parser_append.add_argument('title', help='Title of task.py', default='Title')
        parser_append.add_argument('--date', help='Date of task', default='')
        parser_append.set_defaults(func=self.view.delete_task_by_title)

    def edit_task_title_parser(self):
        parser_append = self.subparsers.add_parser('edit_task_title', help='Edit title')
        parser_append.add_argument('title', help='Title of task', default='Title')
        parser_append.add_argument('new_title', help='Eddited title', default='Title')
    ...
    def get_subtasks_parser(self):
        ...
        parser_append.add_argument('title', help='', default='Title of task')
    ...
    def share_task_permission_parser(self):
        ...
        parser_append.add_argument('user_login', help='', default='Login of user')
    ...
    def get_tasks_by_tag_parser(self):
        ...
        parser_append.add_argument('tag', help='', default='Login of user')
