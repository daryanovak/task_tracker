...
class TaskCommandParsers:
    ...
    def create_periodic_task_parser(self):
        ...
        parser_append.add_argument('status', help='status', default='0', choices=['0', '1', '2'])
        parser_append.add_argument('start_date', help=" date in %d/%m/%y %H:%M", default="")
        parser_append.add_argument('date', help=" date %d/%m/%y %H:%M", default=0)
